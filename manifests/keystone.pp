...
class openstack::keystone (
  ...
  class { '::keystone':
    ...
    public_bind_host        => $::openstack::config::host,
    admin_bind_host         => $::openstack::config::host,
  ...
  class { '::keystone::wsgi::apache':
    ...
    admin_bind_host => $::openstack::config::ip_for_url,
  ...
  class { '::keystone::endpoint':
    default_domain => $default_domain,
    public_url     => $::openstack::config::keystone_auth_uri,
    admin_url      => $::openstack::config::keystone_admin_uri,
  }
  ...
  class { '::openstack_extras::auth_file':
    ...
    user_domain    => 'default',
    auth_url       => "${::openstack::config::keystone_auth_uri}/v3/",
  }
